...
- OLD: бесплатно, paywall никогда не появляется.
- notTier1: бесплатно, paywall никогда не появляется.
- NEW+Tier1:
- 1–10 скачиваний проходят
- после 10-го появляется баннер
- 11-й клик открывает paywall
